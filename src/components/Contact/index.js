...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    emailjs.sendForm('service_2knzqpm', 'template_axnzj79', form.current, 'dskmiXG1ppvSw7mB6')
      .then((result) => {
        setOpen(true);
        form.current.reset();
      }, (error) => {
  ...
  return (
    <Container>
      <Wrapper>
        <Title>Contato</Title>
        <Desc>Sinta-se livre para entrar em contato e tirar suas dúvidas!</Desc>
        <ContactForm ref={form} onSubmit={handleSubmit}>
          <ContactTitle>Mande uma mensagem, é de graça! 🚀</ContactTitle>
